...
%   $Revision: 1.0
  ...
  if max(size(p0))==3
      if max(size(p1))==3
          ...
          y1 = p1(2);
          z1 = p1(3);
          plot3([x0;x1],[y0;y1],[z0;z1],'-b','LineWidth' ,2);   % Draw a line between p0 and p1
          hold on
          plot3(x1,y1,z1,'o-b','LineWidth' ,2);   % Draw a line between p0 and p1
          plot3(x0,y0,z0,'.-r','LineWidth' ,2);   % Draw a line between p0 and p1
